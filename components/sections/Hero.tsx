...
const slides = [
  {
    topic: 'Grow Your Audience',
    headline: ['More Views.', 'More Followers.', 'More Money.'],
    sub: 'Buy TikTok views, Instagram followers, YouTube subscribers and 260+ more services — delivered instantly to your phone.',
    image: 'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=1920&q=85&auto=format&fit=crop',
    accent: '#22c55e',
    cta: { label: 'Start Growing', href: 'https://smm.kagujje.com' },
  },
  {
    topic: 'Automate Your Trading',
    headline: ['Trade Forex', 'While You', 'Sleep.'],
    sub: 'Connect your broker, pick a strategy, and let AI run your trades 24/5. Free demo account — no credit card needed.',
    image: 'https://images.unsplash.com/photo-1611974789855-0c3b8f06e1b9?w=1920&q=85&auto=format&fit=crop',
    accent: '#3b82f6',
    cta: { label: 'Try Free Demo', href: 'https://autoforex.kagujje.com' },
  },
  {
    topic: 'Earn Daily',
    headline: ['Answer Quizzes.', 'Refer Friends.', 'Get Paid.'],
    sub: 'Complete simple tasks every day and withdraw real UGX to MTN MoMo or Airtel in under 2 minutes.',
    image: 'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=1920&q=85&auto=format&fit=crop',
    accent: '#f59e0b',
    cta: { label: 'Start Earning', href: 'https://daily.qzz.io' },
  },
  {
    topic: 'Manage Devices',
    headline: ['Control Every', 'Device In', 'Your Fleet.'],
    sub: 'Remote lock, app management, and real-time monitoring for schools, businesses, and organizations across East Africa.',
    image: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=1920&q=85&auto=format&fit=crop',
    accent: '#8b5cf6',
    cta: { label: 'See MDM28', href: 'https://mdm.kagujje.com' },
  },
]
